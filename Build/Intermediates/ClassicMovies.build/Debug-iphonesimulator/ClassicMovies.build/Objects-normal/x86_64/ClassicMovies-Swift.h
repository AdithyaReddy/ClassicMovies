...
SWIFT_MODULE_NAMESPACE_PUSH("ClassicMovies")
@class UIWindow;
@class UIApplication;

SWIFT_CLASS("_TtC13ClassicMovies11AppDelegate")
...
SWIFT_CLASS("_TtC13ClassicMovies24MoviesFeedViewController")
@interface MoviesFeedViewController : UIViewController
- (void)viewDidLoad;
...
@interface MoviesFeedViewController (SWIFT_EXTENSION(ClassicMovies)) <UITableViewDelegate>
@end
